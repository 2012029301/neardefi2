...
export const LOGIC_CONTRACT_NAME ='dev-1652260071989-20336423861239'|| process.env.CONTRACT_NAME as string;
export const DUST_THRESHOLD = 0.001;

export const hiddenAssets = ["ref.fakes.testnet", "meta-token.near"];

export const defaultNetwork = ('testnet'||process.env.DEFAULT_NETWORK ||
